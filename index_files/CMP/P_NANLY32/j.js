Vue.component("p_nanly32", {
    template: `<div class="w0-modal-content w3-card-4 w3-animate-top" style="top: 0px; left: 19%;">
    <header class="w3-container w3-teal w3-display-container">
    <span onclick="CLSrjk(0);" class="w3-button w3-teal w3-display-topright">
    <i aria-hidden="true" class="fa fa-remove"></i></span>
    <h4 class="*proekt_name">nanly 32</h4></header>
    ...
    <h3>get it from oficial google play store</h3><img onclick="window.open('https://play.google.com/store/apps/details?id=com.qexample.Nanly32');" style="cursor: pointer; width: 70%; min-height: 150px; max-height: 550px;" src="index_files/MEDIA/IMG/Nanly32/googlePLAY.png"></div> <div id="workP1" class="w3-col m7">
    <p class="w3-center ">TECHNICAL SPECIFICATIONS :</p> <form class="w3-container w3-card-4 w3-padding-16 w3-white"><div class="w3-section"><label type="text" class="w3-input">mobile divace : Android (kitkat an newer)</label></div> <div class="w3-section"><label type="text" class="w3-input">memory ROM sortage : 3,17 MB</label></div> <div class="w3-section"><label type="text" class="w3-input">memory RAM usage : 20-30 MB</label></div> <div class="w3-section"><label type="text" class="w3-input">app  version available (in plan): N32 ,N32+ssfd </label></div> <div class="w3-section"><label type="text" class="w3-input">for 1 - 101 years old humans recomendet</label></div></form></div></div></div></div></div>
    <footer class="w3-container w3-teal w3-center"><p>relised 23 Nov 2019 by 1kinger</p></footer></div>`})
